    ...
    return (
        <div className="sidebar-wrapper">
            <div className="sidebar">
                ...
                <div className="menu">
                    <div className="option dashboard active">
                        <div className="icon">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                id="Layer_1"
                        ...
                        <div className="option-name">Dashboard</div>
                    </div>
                    <div className="option calendar">
                        ...
                        <div className="option-name">Calendar</div>
                    </div>
                    <div className="option tasks">
                        ...
                        <div className="option-name">Tasks</div>
                    </div>
                    <div className="option collection">
                        ...
                        <div className="option-name">Collection</div>
                    </div>
                    <div className="option performance">
                        ...
                        <div className="option-name">Performance</div>
                    </div>
                </div>
